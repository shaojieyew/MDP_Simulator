...
public class ExplorationWallerType6 extends Exploration {
	...
	//from rpi
	public  ExplorationWallerType6(boolean isTerminate){
		super(isTerminate);
	}
	
	//from simulator
	public ExplorationWallerType6(){
		super();
	}
	public ExplorationWallerType6(int startAtX, int startAtY){
	...
	public String geType() {
		return ExplorationFactory.EX_WALL6;
	}
}
